# Documentation Tooling Boundaries Specification

## Purpose

Define fixed governed-source discovery, non-blocking delivery visibility, and the narrow documentation tooling command surface.
