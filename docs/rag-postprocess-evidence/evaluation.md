...
| current | `74e5983e468ee38e0e449d353726540994b32767` | `e3bba3d5…dbecffbc` |
...
| 完整步骤组 | 0/8 | 6/8 |
| 完整管线 P50 | 0.384 ms | 0.467 ms |
| 完整管线 P95 | 0.515 ms | 0.818 ms |
...
变为 3/3。当前管线增加 auto-merge 与 step-chain 后，本冻结集 P50/P95 分别增加 0.083 ms
和 0.303 ms；这是模型无关、本机、80 次完整后处理调用的相对开销。
...
| ---: | ---: | ---: | ---: | ---: |
| 10 | 0.2917 | 2/8 | 0.307 ms | 0.576 ms |
| 15 | 0.5417 | 4/8 | 0.378 ms | 0.488 ms |
| 20 | 0.9167 | 6/8 | 0.467 ms | 0.818 ms |
