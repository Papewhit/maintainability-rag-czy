...
| current | `3ed67c97401d49367268464cdb2ec8f27cad8b38` | `8180c6b8…c56af0` |
...
| 完整步骤组 | 0/8 | 6/8 |
| 完整管线 P50 | 0.384 ms | 0.526 ms |
| 完整管线 P95 | 0.515 ms | 0.773 ms |
...
变为 3/3。当前管线增加 auto-merge 与两跳 step-chain 后，本冻结集 P50/P95 分别增加 0.142 ms
和 0.258 ms；这是模型无关、本机、80 次完整后处理调用的相对开销。
...
| ---: | ---: | ---: | ---: | ---: |
| 10 | 0.2917 | 2/8 | 0.406 ms | 0.606 ms |
| 15 | 0.5417 | 4/8 | 0.457 ms | 0.607 ms |
| 20 | 0.9167 | 6/8 | 0.526 ms | 0.773 ms |
