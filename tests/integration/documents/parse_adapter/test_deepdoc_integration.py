...
2. Sample documents in ``tests/fixtures/documents/``.

Run with:
    uv run pytest tests/integration/documents/parse_adapter/test_deepdoc_integration.py -v
Skip in CI with:
...
_MODEL_DIR = os.environ.get("DEEPDOC_MODEL_DIR") or str(
    PROJECT_ROOT / "backend" / "documents" / "parse_adapter" / "deepdoc" / "models"
)
...
class TestExcelIntegration:
    ...
    def test_parse_sample_xlsx(self) -> None:
        ...
        xlsx_path = DOCUMENT_FIXTURES_DIR / "output_rev1.xlsx"
