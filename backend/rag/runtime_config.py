...
class RagRuntimeConfig:
    ...
    step_chain_check_enabled: bool = False
    step_chain_adjacent_lookback: int = 2
...
def load_runtime_config(env: EnvMapping | None = None) -> RagRuntimeConfig:
    ...
    return RagRuntimeConfig(
        ...
        step_chain_check_enabled=_bool(env, "STEP_CHAIN_CHECK_ENABLED", False),
        step_chain_adjacent_lookback=_int(env, "STEP_CHAIN_ADJACENT_LOOKBACK", 2),
