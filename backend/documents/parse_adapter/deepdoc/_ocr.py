...
from ._operators import *  # noqa: F403
...
from ._postprocess import build_post_process
...
def load_model(model_dir, nm):
    ...
    def cuda_is_available():
        # DeepDoc runs on CPU-only in this project.
        # ONNX Runtime CUDA provider is not compatible with
        # the InfiniFlow pre-trained model arena allocation hints.
        return False
